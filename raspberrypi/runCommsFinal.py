...
def updateLed():
    try:
        ...
        if(sensors['3'] >= thresholds['3']  and sensors['1'] <= thresholds['1'] and sensors['2'] <= thresholds['2']):
            ubit.pixels = [0b00000,
                           0b00001,
                           0b00010,
                           0b10100,
                           0b01000]
            print('tick')
        elif(sensors['3'] <= thresholds['3'] and (sensors['1'] < thresholds['1'] or sensors['2'] < thresholds['2']) ):
            ubit.pixels = [0b00100,
                           0b01100,
                           0b00100,
                           0b00100,
        ...
        elif(sensors['3'] > thresholds['3'] and (sensors['1'] >= thresholds['1'] and sensors['2'] >= thresholds['2'])):
            ubit.pixels = [0b11111,
                           0b00001,
                           0b11111,
                           0b10000,
        ...
        elif(sensors['1'] >= thresholds['1'] and sensors['2'] >= thresholds['2'] and sensors['3'] <= thresholds['3']):
            ubit.pixels = [0b10001,
                           0b01010,
                           0b00100,
                           0b01010,
...
def on_connect(client, userdata, flags, rc):
    topic = "iotg5/cp"
    print("Connected to broker", topic)
...
if __name__ == '__main__':
    while (True):
        ...
        p = multiprocessing.Process(target=scan, name="Foo")
        p.start()
        ...
        p.join()
        #print(sensors)
        p = multiprocessing.Process(target=updateLed, name="Foo1")
        p.start()
